...
ELEMENT_DEFINE(CHRC, 187); //first mod element
ELEMENT_DEFINE(SFAC, 188);
ELEMENT_DEFINE(ETHL, 189);
ELEMENT_DEFINE(KERO, 190);
ELEMENT_DEFINE(GASO, 191);
ELEMENT_DEFINE(TIN, 192);
ELEMENT_DEFINE(COPR, 193);
ELEMENT_DEFINE(BRNZ, 194);
ELEMENT_DEFINE(HELI, 195);
ELEMENT_DEFINE(LEAD, 196);
ELEMENT_DEFINE(COBA, 197);
ELEMENT_DEFINE(STEL, 198);
ELEMENT_DEFINE(CROM, 199);
ELEMENT_DEFINE(ALUM, 200);
ELEMENT_DEFINE(DURA, 201);
ELEMENT_DEFINE(COCH, 202);
ELEMENT_DEFINE(MLYB, 203);
ELEMENT_DEFINE(SODI, 204);
ELEMENT_DEFINE(CHLR, 205);
ELEMENT_DEFINE(COCA, 206);
ELEMENT_DEFINE(ANAC, 207);
ELEMENT_DEFINE(TTSL, 208);
ELEMENT_DEFINE(CRUC, 209); //new stuff below
ELEMENT_DEFINE(SALD, 210); 
ELEMENT_DEFINE(MAGN, 211); 
ELEMENT_DEFINE(NICK, 212); 
ELEMENT_DEFINE(ALBR, 213); 
ELEMENT_DEFINE(ALNI, 214); 
ELEMENT_DEFINE(ALNC, 215); 
ELEMENT_DEFINE(TERN, 216); 
ELEMENT_DEFINE(MAGX, 217); 
ELEMENT_DEFINE(PLTU, 218); 
